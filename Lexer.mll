...
|   block_comment    {  }
|   macro            {  }
|   start_enum       { log 1 "Enum"; goto enum }
|   start_typedef    { log 2 "Typedef"; goto typedef }
|   start_struct ';' { log 3 ("Struct "^id) }
|   start_struct '{' { log 3 ("Struct "^id); goto structure }
|   start_fun_dec    { log 4 "FunDec"; goto fun_dec }
|   otherwise        {  }
|   eof              { eof () }
and enum = parse
    ws1                            {  }
...
|   block_comment                  {  }
|   macro                          {  }
|   ident ws line_comment end_enum { log 1 ("AtomDecl "^id);
		                     log 1 ("RBrack"); break () }
|   ident ws '=' ws int ws ',' { log 1 ("AtomDef "^id^" "^i) }
|   ident end_enum { log 1 ("AtomDecl "^id);
		     log 1 ("RBrack"); break () }
|   ident ws ','   { log 1 ("AtomDecl "^id) }
|   otherwise      { skip char }
|   eof            { eof () }
and typedef = parse
    ws          {  }
